...
(function () {
        ...
        toggleConfigs.forEach(({ buttonId, containerId }) => {
            ...
            const handleToggle = () => {
                ...
                if (isExpanded) {
                    ...
                    const parent = extraProducts.length
                        ? extraProducts[0].parentElement
                        : null;
                    ...
                    const totalCards = extraProducts.length;
    ...
    function initScrollAnimations() {
        const animatedElements = document.querySelectorAll('.story-card, .category-tile, .product-card:not(.product-card--extra), .stat-item, .testimonial, .peace-of-mind, .contact-cta, .from-manufacturer__item, .cert-badge, .category-banner, .btn--modern, .btn--gradient');
    ...
    function initComparisonTable() {
        ...
        function highlightColumn(colIndex, active) {
            allRows.forEach(function (row) {
                ...
                if (cell) {
                    if (active) {
                        cell.style.backgroundColor = 'rgba(0, 125, 195, 0.06)';
                    }
                    else {
        ...
        const scrollTargets = [
            function () { return document.getElementById('wwan-routers'); },
            function () { return document.getElementById('wwan-routers'); },
            function () { return document.querySelector('.featured-products--adapters'); },
            function () { return document.querySelector('.featured-products--adapters'); }
        ];
